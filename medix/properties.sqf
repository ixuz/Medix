...
MEDIX_PRP_HELMDEFLECTDISTANCE = 2; // Helmet deflection may occur at distances further than this(meters)
MEDIX_PRP_HELMDEFLECTCHANCE = 90; // The chance(percent) of your helmet deflecting a bullet
MEDIX_PRP_HELMDEFLECTDMG = 0; // The amount of health(percent) lost when helmet deflected a bullet
